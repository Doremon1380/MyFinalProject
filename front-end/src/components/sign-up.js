        ...
        return (
            <>
                ...
                <div id="sign-up-container">
                    ...
                    <form>
                        <div id="flex-box-2">
                            <input name="account name" placeholder="Account name" type="text" id="account-name-input"></input>
                        ...
                        <input name="agree" value="I agree to the Terms of Service and Privacy Policy" id="agree" type="checkbox" />
